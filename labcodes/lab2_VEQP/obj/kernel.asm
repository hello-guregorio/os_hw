...
kern_init(void) {
  ...
  10003a:	b8 00 a0 11 00       	mov    $0x11a000,%eax
  ...
  10004e:	00 
  10004f:	c7 04 24 00 a0 11 00 	movl   $0x11a000,(%esp)
...
print_kerninfo(void) {
  ...
  1008bb:	c7 44 24 04 00 a0 11 	movl   $0x11a000,0x4(%esp)
  1008c2:	00 
...
pmm_init(void) {
  ...
  104718:	8d 90 ac 03 00 00    	lea    0x3ac(%eax),%edx
...
check_boot_pgdir(void) {
  ...
  10525e:	05 ac 03 00 00       	add    $0x3ac,%eax
...
print_pgdir(void) {
  ...
  105698:	e8 b0 ac ff ff       	call   10034d <cprintf>
    ...
    while ((perm = get_pgtable_items(0, NPDEENTRY, right, vpd, &left, &right)) != 0) {
        ...
        size_t l, r = left * NPTEENTRY;
        while ((perm = get_pgtable_items(left * NPTEENTRY, right * NPTEENTRY, r, vpt, &l, &r)) != 0) {
  10569d:	ba 00 00 c0 3a       	mov    $0x3ac00000,%edx
...
print_pgdir(void) {
    ...
    size_t left, right = 0, perm;
    while ((perm = get_pgtable_items(0, NPDEENTRY, right, vpd, &left, &right)) != 0) {
  1056e4:	ba 00 b0 ce 3a       	mov    $0x3aceb000,%edx
